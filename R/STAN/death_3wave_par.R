...
countrylist = c("Colombia", "France", "Greece", "Indonesia", "Iraq",
  "Japan", "Korea, South", "Morocco", "Netherlands", "Panama",
  "Portugal", "Romania", "Spain", "Turkey", "Ukraine",
  "United Kingdom", "US") # 17
...
registerDoMC(cores = 17)    # Alternativa Linux
