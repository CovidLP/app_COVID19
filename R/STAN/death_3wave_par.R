...
###################################################################
countrylist <- c("Belgium", "Canada", "Costa Rica", "France", "Germany",
                 "Indonesia", "Iraq", "Italy", "Japan", "Korea, South",
                 "Morocco", "Netherlands", "Norway", "Panama", "Poland",
                 "Portugal", "Spain", "Sweden", "Ukraine", "United Kingdom") # 20
