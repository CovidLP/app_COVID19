...
countrylist <- c("Argentina","Belgium","Bolivia","Canada","Chile","China","Colombia","Ecuador","France","Germany","Greece", "India", "Ireland", "Italy", "Korea, South", "Mexico", "Netherlands", "New Zealand", "Norway", "Peru", "Paraguay", "Poland", "Portugal", "Russia", "South Africa", "Spain","United Kingdom", "Uruguay", "Sweden", "Switzerland", "Turkey", "Venezuela", "Costa Rica", "Morocco", "Panama", "Philipines", "Saudi Arabia", "Ukraine", "Ethiopia", "Guatemala", "Honduras", "Indonesia", "Iraq")                    
...
registerDoMC(cores = 43)    # Alternativa Linux
