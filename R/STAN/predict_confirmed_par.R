...
countrylist <- c("Argentina","Bolivia","Chile","China","Colombia","Ecuador","France","Greece", "India", "Ireland", "Korea, South", "Mexico", "Netherlands", "New Zealand", "Norway", "Peru", "Paraguay", "Russia", "South Africa", "Uruguay", "Sweden", "Switzerland", "Turkey", "Venezuela", "Costa Rica", "Morocco", "Panama", "Philipines", "Ukraine", "Ethiopia", "Guatemala", "Honduras", "Indonesia", "Iraq")                    
...
registerDoMC(cores = 34)    # Alternativa Linux
